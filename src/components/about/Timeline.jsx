  ...
  return (
    <section className="relative bg-bg px-6 py-24 md:px-10">
      <div className="mx-auto max-w-4xl">
        <Reveal>
          <h2 className="font-heading uppercase text-4xl text-white md:text-5xl">{t("timeline.heading")}</h2>
        ...
        <div className="relative mt-16 space-y-14 border-l border-white/10 pl-10">
          {timeline.map((t, i) => (
            <Reveal key={t.year} delay={i * 0.1} className="relative">
              ...
              <h3 className="mt-1 uppercase font-heading text-xl text-white">{t.title}</h3>
